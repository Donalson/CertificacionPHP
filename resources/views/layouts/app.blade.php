...
<head>
    ...
    <title>Antojitos Heidy</title>
    <link rel="icon" href="logo.ico" type="image/x-icon" sizes="128x128">
...
<body class="fondo">
    <div id="app">
        <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-danger shadow-sm">
            <div class="container">
