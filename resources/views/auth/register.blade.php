            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('DPI') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="Fnacimiento" class="col-md-4 col-form-label text-md-right">{{ __('Fnacimiento') }}</label>

                            <div class="col-md-6">
                                <input id="Fnacimiento" type="date" class="form-control @error('Fnacimiento') is-invalid @enderror" name="Fnacimiento" value="{{ old('Fnacimiento') }}" required autocomplete="Fnacimiento" autofocus>
